...
{
    [DefaultClassOptions, Persistent("ENMENSILEXIMPIANTO")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Consumi Mensili Impianto")]
    [ImageName("Action_Inline_Edit")]
    [NavigationItem("Energia")]
    public class ConsumiMensileImpianto : XPObject
    {
        public ConsumiMensileImpianto() : base() { }

        public ConsumiMensileImpianto(Session session) : base(session) { }
        ...
        [Persistent("IMPIANTO"), DisplayName("Servizio")]
        [Delayed(true)]
        ...
        [Association(@"ConsumiMensileImpianto_Apparato", typeof(ConsumiMensileApparato)), Aggregated, DisplayName("Dettaglio Mensile")]
        public XPCollection<ConsumiMensileApparato> ConsumiMensileApparatos
        {
            get
            {
                return GetCollection<ConsumiMensileApparato>("ConsumiMensileApparatos");
            }
        }
        ...
        [Appearance("ConsumiMensileImpianto.DataAggiornamento", Enabled = false)]
