...
{
    [DefaultClassOptions, Persistent("ENGGXAPPARATO")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Consumi Giornalieri")]
    [ImageName("Action_Inline_Edit")]
    [NavigationItem("Energia")]
    public class ConsumiGiornalieriApparato : XPObject
    {
        public ConsumiGiornalieriApparato() : base() { }

        public ConsumiGiornalieriApparato(Session session) : base(session) { }

        public override void AfterConstruction() { base.AfterConstruction(); }

        [Association(@"ConsumiMensileApparato_Giornaliero"), Persistent("ENMENSILEXAPPARATO")]
        [Delayed(true)]
        public ConsumiMensileApparato ConsumiMensileApparato
        {
            get { return GetDelayedPropertyValue<ConsumiMensileApparato>("ConsumiMensileApparato"); }
            set { SetDelayedPropertyValue<ConsumiMensileApparato>("ConsumiMensileApparato", value); }
        }
        ...
        [Appearance("ConsumiGiornalieriApparato.DataAggiornamento", Enabled = false)]
