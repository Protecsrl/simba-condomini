...
namespace CAMS.Module.DBALibrary
{
    ...
    public class KOttimizzazione : XPObject
    {
        ...
        [DbType("varchar(50)")]      
        [RuleRequiredField("RuReqField.KOttimizzazione", DefaultContexts.Save, "La Descrizione è un campo obbligatorio")]
        [RuleUniqueValue("RuleCombIsUnique.KOttimizzazione.Desc", DefaultContexts.Save, "Descrizione",
CustomMessageTemplate = @"Attenzione è stato già inserito una Descrizione({Descrizione}) già presente. Reinserirla Nuovamente.",
