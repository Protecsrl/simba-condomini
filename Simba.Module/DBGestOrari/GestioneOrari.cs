...
{
    [DefaultClassOptions, Persistent("GESTIONEORARI")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Gestione Orari")]
    ...
    [Appearance("GestioneOrari.StrumentiModificaOrari.noVisibile", AppearanceItemType.LayoutItem,
        @"SAutorizzativo.Oid == 8 Or (SAutorizzativo.Oid == 10 And !RuoloAutorizzativo) Or SAutorizzativo.Oid > 10", TargetItems = "StrumentiModificaCalendario", Visibility = ViewItemVisibility.Hide)]
    ...
    [Appearance("GestioneOrari.Colorefield.SAutorizzativo.colore2", AppearanceItemType.ViewItem, @"SAutorizzativo.Oid =9",
             TargetItems = "SAutorizzativo", Context = "Any", Priority = 1, FontStyle = FontStyle.Bold, FontColor = "purple")]
    ...
    public class GestioneOrari : XPObject
    {
        public GestioneOrari() : base()
        {
            // This constructor is used when an object is loaded from a persistent storage.
            // Do not place any code here.
        }

        public GestioneOrari(Session session) : base(session)
        {
            // This constructor is used when an object is loaded from a persistent storage.
            // Do not place any code here.
        }
        ...
        [RuleRequiredField("RuleReq.GestioneOrari.Descrizione.Save", DefaultContexts.Save, "Descrizione è un campo obbligatorio!, inserisci una descrizione della Gestione Orari che stai inserendo")]
        [RuleRequiredField("RuleReq.GestioneOrari.Descrizione.AzioneModificaGOrari", "AzioneModificaGOrari", "Descrizione è un campo obbligatorio!, inserisci una descrizione della Gestione Orari che stai inserendo")]
        ...
        [Appearance("GestioneOrari.MessaggioInformativo.BackColor.Red", FontColor = "Red", Priority = 1, Criteria = "SAutorizzativo is not null")]
        ...
        string fStagione;
        [Indexed(Name = @"GestioneOrari_idx_Stagione")]
        [Size(255)]
