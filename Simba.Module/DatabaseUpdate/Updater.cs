...
namespace CAMS.Module.DatabaseUpdate {
	public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
           ...
           userRole.SetTypePermissionsRecursively<SecuritySystemTypePermissionsObjectBase>(SecurityOperations.FullAccess, SecuritySystemModifier.Deny);
           userRole.SetTypePermissionsRecursively<SecuritySystemTypePermissionsObjectOwner>(SecurityOperations.FullAccess, SecuritySystemModifier.Deny);
