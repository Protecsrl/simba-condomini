...
namespace CAMS.Module.Classi.Effemeridi
{
    ...
    public sealed class SunTimes
    {
        ...
        public bool CalculateSunRiseSetTimes(LatitudeCoords lat, LongitudeCoords lon, DateTime date,
                                                ...
                                                ref bool isSunrise, ref bool isSunset, ref double lightHours, ref double darkHours, ref bool isSummerTime)
        {
            return CalculateSunRiseSetTimes(lat.ToDouble(), lon.ToDouble(), date, ref riseTime, ref setTime, ref isSunrise, ref isSunset, ref lightHours, ref darkHours, ref isSummerTime);
        }
                                                ...
                                                ref bool isSunrise, ref bool isSunset, ref double lightHours, ref double darkHours, ref bool isSummerTime)
        {
            lock (mLock)    // lock for thread safety
            {
                ...
                TimeSpan diff = setTime - riseTime;
                lightHours = diff.TotalHours;
                darkHours = 24 - lightHours;
                isSummerTime = date.IsDaylightSavingTime();
