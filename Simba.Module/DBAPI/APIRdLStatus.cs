...
namespace CAMS.Module.DBAPI
{
    [NavigationItem("Amministrazione"), System.ComponentModel.DisplayName("RdLStatus")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "RdLStatus")]
    ...
    public class APIRdLStatus : XPObject
    {
        ...
        public APIRdLStatus(Session session)
            : base(session)
        {
        }
        ...
        [Association(@"ApiRdLStatus_Dett", typeof(APIRdLStatusDett)), DevExpress.Xpo.Aggregated]
        [DisplayName("ApiRdLStatus Dettaglio")]
        ...
        public XPCollection<APIRdLStatusDett> APIRdLStatusDetts
        {
            get
            {
                return GetCollection<APIRdLStatusDett>("APIRdLStatusDetts");
            }
        }
