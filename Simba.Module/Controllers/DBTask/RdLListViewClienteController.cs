...
namespace CAMS.Module.Controllers.DBTask
{
    ...
    public partial class RdLListViewClienteController : ViewController
    {
        public RdLListViewClienteController()
        {
            InitializeComponent();
        ...
        void LViewController_CustomDetailView(object sender, CustomProcessListViewSelectedItemEventArgs e)
        {
            ...
            {
                string detailview = "RdL_DetailView_Cliente";
                ...
                e.Handled = true;
                DetailView NewDv;
                RdL GetRdL = xpObjectSpace.GetObjectByKey<RdL>(((RdLListViewCliente)View.CurrentObject).Codice);
                GetRdL.StatoSmistamentoCliente = "PV Presa Visione";
