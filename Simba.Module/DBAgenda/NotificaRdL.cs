...
{
    [DefaultClassOptions, Persistent("NOTIFICARDL")]
    [NavigationItem("Ticket")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Notifiche RdL")]
    [ImageName("SwitchTimeScalesTo")]

    //[Appearance("NotificaRdL.Label.stato1", TargetItems = "Oid",
    //        Criteria = @"Label = 1", FontStyle = FontStyle.Bold, BackColor = "Salmon")]
   ...
   TargetItems = "StartDate;DueDate;DateCompleted;DataCreazione",
    ...
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("NotificheAttive", "StatusNotifica != 'Completed'", "Notifiche Attive", true, Index = 0)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("NotificheNonAttive", "StatusNotifica = 'Completed'", "Notifiche Completate", Index = 1)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("Tutte le Notifiche", "", "Tutto", Index = 2)]
    ...
    public class NotificaRdL : XPObject, IEvent, ISupportNotifications
    {
        public NotificaRdL(Session session)
            : base(session)
        {
            Resources.ListChanged += new ListChangedEventHandler(Resources_ListChanged);
        }
        public NotificaRdL() : base() { }
        ...
        public override void AfterConstruction()
        {
            ...
            if (this.Oid == -1)
            {
                this.StatusNotifica = TaskStatus.NotStarted;
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(resourceIds))
                {
                    ...
                    foreach (XmlNode xmlNode in xmlDocument.DocumentElement.ChildNodes)
                    {
                        ...
                        AppuntamentiRisorse resource = Session.GetObjectByKey<AppuntamentiRisorse>(int.Parse(keyMemberValue.ToString()));
                        if (resource != null)
                        {
        ...
        public void UpdateResourceIds()
        {
            ...
            foreach (AppuntamentiRisorse resource in Resources)//    foreach (Resource resource in Resources)
            {
        ...
        [Persistent("LOCATION")]
        [DevExpress.ExpressApp.DC.XafDisplayName("Indirizzo")]
        ...
        public LabelListView LabelListView
        {
                //get
                //{
                //    var tempObject = EvaluateAlias("LabelListView");
                //    if (tempObject != null)
                //    {                        
                //        appointmentImpl.Label = (int) tempObject;
                //        return (LabelListView)appointmentImpl.Label;
                //    }
                //    else
                //        return 0;
                //}
            get
            {
                ...
                return fLabelListView;
            }
            set
            {
                SetPropertyValue<LabelListView>("LabelListView", ref fLabelListView, value);
            }
        }
        ...
        [Indexed]
        [Persistent("START_ON")]
        [DevExpress.ExpressApp.DC.XafDisplayName("Inizio Intervento Pianificato")]
        ...
        [Indexed]
        [Persistent("END_ON")]
        [XafDisplayName("Fine Intervento Pianificato")]
        [DevExpress.ExpressApp.Model.ModelDefault("DisplayFormat", "{0:" + DateAndTimeOfDayEditMask + "}")]
        [DevExpress.ExpressApp.Model.ModelDefault("EditMask", DateAndTimeOfDayEditMask)]
        [EditorAlias(CAMSEditorAliases.Pers_DataOrario_Editor)]
        ...
        [ImmediatePostData]
        [XafDisplayName("Team di Risorse")]
        public XPCollection<AppuntamentiRisorse> Resources //  public XPCollection<Resource> Resources
        {
            get
            {
                return GetCollection<AppuntamentiRisorse>("Resources");
            }
        }
        ...
        //[BrowsableAttribute(false)]
        public TaskStatus StatusNotifica
        {
