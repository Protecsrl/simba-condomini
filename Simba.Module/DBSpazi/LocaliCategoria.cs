...
{    
    [DefaultClassOptions, Persistent("LOCALICATEGORIA")]
    [System.ComponentModel.DefaultProperty("Descrizione")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Categoria Locale")]
    [ImageName("Action_EditModel")]
    [NavigationItem("Gestione Spazi")]
   public class LocaliCategoria: XPObject
    {        
        public LocaliCategoria() : base() { }
        public LocaliCategoria(Session session) : base(session) { }
        public override void AfterConstruction() { base.AfterConstruction(); }

        private string fDescrizione;
        [Persistent("DESCRIZIONE"), Size(100), DevExpress.Xpo.DisplayName("Descrizione")]
        [DbType("varchar(100)")]
        [RuleRequiredField("RReqField.LocaliCategoria.Descrizione", DefaultContexts.Save, "La Descrizione è un campo obbligatorio")]
        ...
        [Persistent("COD_DESCRIZIONE"), Size(25), DevExpress.Xpo.DisplayName("Cod Descrizione"), Appearance("LocaliCategoria.CodDescrizione", Enabled = true)]
        [DbType("varchar(100)")]
