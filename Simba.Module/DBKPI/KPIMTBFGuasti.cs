...
{
    [DefaultClassOptions, Persistent("KPI_MTBF_GUASTI")] //fai fare la vista ad andrea
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "KPI MTBF Guasti")]
    [ImageName("StackedLine")]
    [NavigationItem("KPI")]

    public class KPIMTBFGuasti :  XPLiteObject   
    {
        public KPIMTBFGuasti()
            : base()
        {
        }

        public KPIMTBFGuasti(Session session)
            : base(session)
        {
        }
        ...
        private DateTime fDataCompletamentoPrecedente;
        [Persistent("DATA_COMPLETAMENTO_PRECEDENTE"), System.ComponentModel.DisplayName("Data Completamento Precedente")]
        ...
        public DateTime DataCompletamentoPrecedente
        {
            get
            {
                return fDataCompletamentoPrecedente;
            }
            set
            {
                SetPropertyValue<DateTime>("DataCompletamentoPrecedente", ref fDataCompletamentoPrecedente, value);
            }
        }
