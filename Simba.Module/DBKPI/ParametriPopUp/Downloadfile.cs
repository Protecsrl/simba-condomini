...
namespace CAMS.Module.DBKPI.ParametriPopUp
{
    ...
    public class Downloadfile : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        ...
        private FileData sampleProperty;
        [XafDisplayName("Dovnload File"), ToolTip("Scarica il file")]
        //[ModelDefault("EditMask", "(000)-00"), VisibleInListView(false)]
        //[RuleRequiredField(DefaultContexts.Save)]
        public FileData SampleProperty
        {
