...
//{
//    class RegRdLListViewMP
//    {
//    }
//}
namespace CAMS.Module.DBTask.Vista
{
    [DefaultClassOptions, Persistent("V_REGRDL_LIST_MP")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Agenda Interventi MP")]
    ...
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_1", "OidSmistamento = 1", "In Attesa di Assegnazione", true, Index = 0)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP", "", "Tutto", Index = 1)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_2", "OidSmistamento = 2", "Assegnata", Index = 2)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_3", "OidSmistamento = 3", "Emessa In lavorazione", Index = 3)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_6", "OidSmistamento = 6", "Sospesa SO", Index = 4)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_10", "OidSmistamento = 10", "In Emergenza da Assegnare", Index = 5)]
    [DevExpress.ExpressApp.SystemModule.ListViewFilter("RdLListViewMP.OidSmistamento_11", "OidSmistamento = 11", "Gestione da Sala Operativa", Index = 6)]
    ...
    public class RegRdLListViewMP : XPLiteObject
    {
        public RegRdLListViewMP() : base() { }
        public RegRdLListViewMP(Session session) : base(session) { }
...
#pragma warning restore CS1503 // Argomento 3: non è possibile convertire da 'DevExpress.Utils.ToolTipIconType' a 'DevExpress.Persistent.Base.ToolTipIconType'
        ...
        [Persistent("APPARATO"),
        Size(50)]
        [DevExpress.Xpo.DisplayName("Apparato")]
        [DbType("varchar(50)")]
        //[RuleRequiredField("RReqField.Apparato.Descrizione", DefaultContexts.Save, "La Descrizione è un campo obbligatorio")]
        ...
        [Persistent("APPARATOPADRE"),
        Size(50)]
        [DevExpress.Xpo.DisplayName("Apparato Padre")]
        [DbType("varchar(20)")]
        //[RuleRequiredField("RReqField.Apparato.Descrizione", DefaultContexts.Save, "La Descrizione è un campo obbligatorio")]
