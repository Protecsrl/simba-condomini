...
namespace CAMS.Module.DBTask.Vista
{
    [DefaultClassOptions, Persistent("V_RDL_LIST_MP")]
    [DevExpress.ExpressApp.Model.ModelDefault("Caption", "Navigazione Interventi MP")]
    ...
    public class RdLListViewMP : XPLiteObject
    {
        public RdLListViewMP() : base() { }
        public RdLListViewMP(Session session) : base(session) { }
